        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © meshmalonza.42web.io/ 2020</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Developed by <a href="https://meshmalonza.42web.io/" target="_blank">Meshack Malonza</a> from meshmalonza.42web.io/</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
